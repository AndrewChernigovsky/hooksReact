...
export const UseStateExample9 = ({ title, srcPath, nextPageUrl }) => {
  ...
  return (
    <div>
      ...
      <p>Короткое имя для JavaScript указано неверно и мы хотим его поменять</p>
      ...
      <p>
        Зная то, что метод <code>map</code> возвращает нам новый массив мы
